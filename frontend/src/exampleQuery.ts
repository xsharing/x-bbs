...
import { Environment, graphql, Network, RecordSource, Store, Variables } from "relay-runtime";
...
export const exampleQuery = graphQLSelector({
    ...
    `,
    variables: {},
    mapResponse: function (response: any, callbacks: { get: GetRecoilValue; variables: Variables; }): unknown {
        return response;
    }
});